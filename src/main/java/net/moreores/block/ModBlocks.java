...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_RADIANT_ORE = ModRegistry.BlockRegistry.register("deepslate_radiant_ore", new ExperienceDroppingBlock(UniformIntProvider.create(1, 2), AbstractBlock.Settings.create().requiresTool().strength(11f, 11f).strength(11f).sounds(BlockSoundGroup.DEEPSLATE).mapColor(MapColor.STONE_GRAY)));
