...
public class ModBlocks {
    ...
    public static final Block GEM_POLISHER_BLOCK = register("gem_polisher_block", new GemPolisherBlock(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreOresModInitializer.MOD_ID, "gem_polisher_block"))).strength(5f).strength(2.75f, 3f).requiresTool().nonOpaque().sounds(BlockSoundGroup.HEAVY_CORE)));
    public static final Block GEM_STORAGE_BLOCK = register("gemstone_storage_block", new Block(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreOresModInitializer.MOD_ID, "gemstone_storage_block"))).strength(5f).strength(2.75f, 3f).requiresTool().nonOpaque().sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block BLUE_GARNET_ORE = register("blue_garnet_ore", new ExperienceDroppingBlock(UniformIntProvider.create(2, 3), AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreOresModInitializer.MOD_ID, "blue_garnet_block"))).requiresTool().strength(7.0f, 7.5f).strength(8.0f).sounds(BlockSoundGroup.STONE).mapColor(MapColor.STONE_GRAY)));
