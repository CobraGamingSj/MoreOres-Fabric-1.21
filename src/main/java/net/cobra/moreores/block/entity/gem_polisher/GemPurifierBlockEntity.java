...
public class GemPurifierBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<GemPurifierData>, ImplementedInventory, TickableBlockEntity {
    ...
    private final ServerRecipeManager.MatchGetter<GemPurifyingRecipeInput, GemPurifierRecipe> matchGetter = ServerRecipeManager.createCachedMatchGetter(GemPurifierRecipe.Type.GEM_PURIFYING);
    ...
    protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        nbt.putString("EnergyState", energyState.name());
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        if(nbt.contains("EnergyState", NbtElement.STRING_TYPE)) {
            energyState = EnergyState.valueOf(nbt.getString("EnergyState"));
        }
    }
...
//        long finalAmount = (long) (amount * time);
    ...
    private boolean hasPolishingFinished() {
        return initialProgress >= firstSlotMaxProgressTick;
    }
