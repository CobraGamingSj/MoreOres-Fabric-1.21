...
public record GemPolishingRecipeDisplay(SlotDisplay ingredient, SlotDisplay result, SlotDisplay workStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.Serializer<GemPolishingRecipeDisplay> SERIALIZER = new RecipeDisplay.Serializer<>(CODEC, PACKET_CODEC);

    @Override
    public RecipeDisplay.Serializer<GemPolishingRecipeDisplay> serializer() {
        return SERIALIZER;
    }
}
