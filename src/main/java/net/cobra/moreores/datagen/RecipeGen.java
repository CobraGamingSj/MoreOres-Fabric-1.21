    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                offerSmelting(RUBY_SMELTABLES, RecipeCategory.MISC, ModItems.RUBY, 0.15f, 1500, "ruby");
                offerSmelting(SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.SAPPHIRE, 0.15f, 1500, "sapphire");
                offerSmelting(GREEN_SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.GREEN_SAPPHIRE, 0.15f, 1500, "green_sapphire");
                offerSmelting(BLUE_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.BLUE_GARNET, 0.15f, 1500, "blue_garnet");
                offerSmelting(PINK_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.PINK_GARNET, 0.15f, 1500, "pink_garnet");
                offerSmelting(GREEN_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.GREEN_GARNET, 0.15f, 1500, "green_garnet");
                offerSmelting(TOPAZ_SMELTABLES, RecipeCategory.MISC, ModItems.TOPAZ, 0.15f, 1500, "topaz");
                offerSmelting(WHITE_TOPAZ_SMELTABLES, RecipeCategory.MISC, ModItems.WHITE_TOPAZ, 0.15f, 1500, "white_topaz");
                offerSmelting(PERIDOT_SMELTABLES, RecipeCategory.MISC, ModItems.PERIDOT, 0.15f, 1500, "peridot");
                offerSmelting(JADE_SMELTABLES, RecipeCategory.MISC, ModItems.JADE, 0.15f, 1500, "jade");
                offerSmelting(PYROPE_SMELTABLES, RecipeCategory.MISC, ModItems.PYROPE, 0.15f, 1500, "pyrope");

                offerBlasting(RUBY_SMELTABLES, RecipeCategory.MISC, ModItems.RUBY, 0.15f, 750, "ruby");
                offerBlasting(SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.SAPPHIRE, 0.15f, 750, "sapphire");
                offerBlasting(GREEN_SAPPHIRE_SMELTABLES, RecipeCategory.MISC, ModItems.GREEN_SAPPHIRE, 0.15f, 750, "green_sapphire");
                offerBlasting(BLUE_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.BLUE_GARNET, 0.15f, 750, "blue_garnet");
                offerBlasting(PINK_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.PINK_GARNET, 0.15f, 750, "pink_garnet");
                offerBlasting(GREEN_GARNET_SMELTABLES, RecipeCategory.MISC, ModItems.GREEN_GARNET, 0.15f, 750, "green_garnet");
                offerBlasting(TOPAZ_SMELTABLES, RecipeCategory.MISC, ModItems.TOPAZ, 0.15f, 750, "topaz");
                offerBlasting(WHITE_TOPAZ_SMELTABLES, RecipeCategory.MISC, ModItems.WHITE_TOPAZ, 0.15f, 750, "white_topaz");
                offerBlasting(PERIDOT_SMELTABLES, RecipeCategory.MISC, ModItems.PERIDOT, 0.15f, 750, "peridot");
                offerBlasting(JADE_SMELTABLES, RecipeCategory.MISC, ModItems.JADE, 0.15f, 750, "jade");
                offerBlasting(PYROPE_SMELTABLES, RecipeCategory.MISC, ModItems.PYROPE, 0.15f, 750, "pyrope");
