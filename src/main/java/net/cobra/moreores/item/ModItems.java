...
public class ModItems {
    ...
    //Gemstones & Ingots
    public static final Item RUBY = register("ruby", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby")))) {
        @Override
    ...
    public static final Item RADIANT = register("radiant", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("radiant")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item SAPPHIRE = register("sapphire", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item GREEN_SAPPHIRE = register("green_sapphire", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("green_sapphire")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item PINK_GARNET = register("pink_garnet", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("pink_garnet")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item BLUE_GARNET = register("blue_garnet", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("blue_garnet")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item GREEN_GARNET = register("green_garnet", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("green_garnet")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item TOPAZ = register("topaz", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("topaz")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item PERIDOT = register("peridot", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("peridot")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item WHITE_TOPAZ = register("white_topaz", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("white_topaz")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item PYROPE = register("pyrope", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("pyrope")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    public static final Item JADE = register("jade", new Item(new Item.Settings().fireproof().rarity(Rarity.RARE).registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("jade")))) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("moreores.tooltip.gem").formatted(Formatting.BLUE));
            super.appendTooltip(stack, context, tooltip, type);
    ...
    //  Ruby Tools & Weapons
    public static final Item RUBY_SWORD = register("ruby_sword", new SwordItem(ModToolMaterials.RUBY, 6, -2.1f, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_sword")))));
    public static final Item RUBY_PICKAXE = register("ruby_pickaxe", new PickaxeItem(ModToolMaterials.RUBY,  2, -3.0f, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_pickaxe")))));
    ...
    public static final Item RUBY_HELMET = register(
            "ruby_helmet",
            new ArmorItem(ModArmorMaterials.RUBY, EquipmentType.HELMET, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_helmet"))))
    );
    public static final Item RUBY_CHESTPLATE = register(
            "ruby_chestplate",
            new ArmorItem(ModArmorMaterials.RUBY, EquipmentType.CHESTPLATE, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_chestplate"))))
    );
    public static final Item RUBY_LEGGINGS = register(
            "ruby_leggings",
            new ArmorItem(ModArmorMaterials.RUBY, EquipmentType.LEGGINGS, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_leggings"))))
    );
    public static final Item RUBY_BOOTS = register(
            "ruby_boots",
            new ArmorItem(ModArmorMaterials.RUBY, EquipmentType.BOOTS, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("ruby_boots"))))
    );
    ...
    public static final Item SAPPHIRE_HELMET = register(
            "sapphire_helmet",
            new ArmorItem(ModArmorMaterials.SAPPHIRE, EquipmentType.HELMET, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_helmet"))))
    );
    public static final Item SAPPHIRE_CHESTPLATE = register(
            "sapphire_chestplate",
            new ArmorItem(ModArmorMaterials.SAPPHIRE, EquipmentType.CHESTPLATE, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_chestplate"))))
    );
    public static final Item SAPPHIRE_LEGGINGS = register(
            "sapphire_leggings",
            new ArmorItem(ModArmorMaterials.SAPPHIRE, EquipmentType.LEGGINGS, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_leggings"))))
    );
    public static final Item SAPPHIRE_BOOTS = register(
            "sapphire_boots",
            new ArmorItem(ModArmorMaterials.SAPPHIRE, EquipmentType.BOOTS, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_boots"))))
    );


    //    Sapphire Tools & Weapons
    public static final Item SAPPHIRE_SWORD = register("sapphire_sword", new SwordItem(ModToolMaterials.SAPPHIRE,  8, -2.0f, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_sword")))));
    public static final Item SAPPHIRE_PICKAXE = register("sapphire_pickaxe", new PickaxeItem(ModToolMaterials.SAPPHIRE,  4, -3.0f, new Item.Settings().fireproof().registryKey(RegistryKey.of(RegistryKeys.ITEM, MoreOresModInitializer.getId("sapphire_pickaxe")))));
